/* @ts-self-types="./gtfs_rt_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function analyze_feed(bytes) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.analyze_feed(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gtfs_rt_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
